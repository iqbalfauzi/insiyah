	...
	<a href="index.php">
		...
		<h2><div class="item">
					<a href="index.php" class="image">
						<img data-echo="brandsimage/logo3.png" src="assets/images/blank.gif" alt="">
					</a>	</h2>
...
if(!empty($_SESSION['cart'])){
	...
	?>
			...
			<div class="clearfix cart-total">
				...
				<a href="my-cart.php" class="btn btn-upper btn-primary btn-block m-t-20">Keranjang Saya</a>	
			</div><!-- /.cart-total-->
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">mulai belanja</a>	
			</div><!-- /.cart-total-->
