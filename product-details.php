...
if(isset($_POST['submit']))
{
	...
	$respon_penjual=$_POST['respon_penjual'];
	$strategi_promosi=$_POST['strategi_promosi'];
	$KT=$_POST['KT'];
	$name=$_POST['name'];
	$summary=$_POST['summary'];
	$review=$_POST['review'];
	mysqli_query($con,"insert into productreviews(productId,harga,quality,merk,kecepatan_pengiriman,respon_penjual,strategi_promosi,KT,name,summary,review) values('$pid','$hrg','$qty','$merk','$kecepatan_pengiriman','$respon_penjual','$strategi_promosi','$KT','$name','$summary','$review')");
}
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">Kategory</h3>
		...
		<div class="accordion">
	    	...
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a href="category.php?cid=<?php echo $row4['id'];?>"  class="accordion-toggle collapsed">
	                   <?php echo $row4['categoryName'];?>
	                </a>
	            </div>
			...
			<?php
				...
				<div class="item">
					<div class="products">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary">Masukkan Keranjang</a>
						...
						<div class="product-info">
									 ...
									 <table>
										...
										?>	
								         <tr> 
											...
											<?php } elseif ( $row3['rating_produk'] < '2') { ?>
										    ...
										    <?php } elseif ( $row3['rating_produk'] < '3') { ?>
										    ...
										    <?php } elseif ( $row3['rating_produk'] < '4') { ?>
										    ...
										    <?php } elseif ( $row3['rating_produk'] < '5') { ?>
										...
										<td>
										<?php
											$ret=mysqli_query($con,"SELECT COUNT(id_user_penilaian) as jml_rvw FROM penilaian_rating WHERE id_barang_penilaian = $pid");
											$row2 = mysqli_fetch_assoc($ret);
										{?> 
											<div class="reviews"> 
												<a href="#" class="lnk" style="margin-left: 10px">  (<?php echo htmlentities($row2['jml_rvw']);?> Reviews)</a>
											</div>  
										<?php } ?>
									</td>
								</tr>
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Merk Produk:</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-2">
										<span class="label">Jumlah brg :</span>
									</div>
									...
									<div class="col-sm-7">
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> MASUKKAN KERANJANG</a>
									</div>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Reviews Pelanggan</h4>
											<table>
											<?php $qry=mysqli_query($con,"SELECT nama_kriteria, total_rating FROM rating_group,kriteria  where rating_group.id_kriteria_group=kriteria.id_kriteria and id_barang_group='$pid'");
											...
											?> 													
											    <tr>
												    <td>
												    	<label><?php echo htmlentities($rvw['nama_kriteria']);?> :&ensp; </label>
												    </td>
												     <td><?php if ( $rvw['total_rating'] < '1') { ?>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Masuukkan Keranjang</a>
