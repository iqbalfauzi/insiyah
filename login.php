...
<html lang="en">
	<head>
	    ...
	    <title>Toko Empat Saudara | Sign-in | Signup</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">sign in</h4>
	<p class="">Hello, Selamat Datang di Toko Kami.</p>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Kata Sandi <span>*</span></label>
		 <input type="password" name="password" class="form-control unicase-form-control text-input" id="exampleInputPassword1" >
		</div>
		<div class="radio outer-xs">
		  	<a href="forgot-password.php" class="forgot-password pull-right">Lupa Kata Sandi?</a>
		</div>
...
<div class="form-group">
	    	<label class="info-title" for="contactno">No HP. <span>*</span></label>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">Konfirmasi Kata Sandi <span>*</span></label>
	...
	<span class="checkout-subtitle outer-top-xs">Daftar Hari ini, dan dapatkan :  </span>
	<div class="checkbox">
	  	<label class="checkbox">
		 Proses pembayaran yang cepat.
		</label>
		<label class="checkbox">
		Melacak pesanan dengan mudah.
		</label>
		<label class="checkbox">
 		Mencatat semua pembelian Anda.
		</label>
	</div>
</div>	
