				...
				<div class='col-md-3 sidebar'>
					...
					<div class='col-md-9'>
						...
						<div id="category" class="category-carousel hidden-xs">
							<div class="item">	
								<div class="image">
									<img src="assets/images/banners/Category1.jpg" alt="" class="img-responsive">
								</div>
										...
										<div class="row">									
											...
											if($num>0){
												while ($row=mysqli_fetch_array($ret)) { ?>							
														...
														<div class="products">				
															<div class="product">		
																...
																<div class="product-info text-left">
																	...
																	<?php
																		$ret2=mysqli_query($con,"select * from products where id='".$row['id']."'");
																		while ($row2=mysqli_fetch_array($ret2)) 
																		{								
																	?>	 
																		<?php if ( $row2['rating_produk'] < '1') { ?>
																		...
																		<?php } elseif ( $row2['rating_produk'] < '2') { ?>
																	    ...
																	    <?php } elseif ( $row2['rating_produk'] < '3') { ?>
																	    ...
																	    <?php } elseif ( $row2['rating_produk'] < '4') { ?>
																	    ...
																	    <?php } elseif ( $row2['rating_produk'] < '5') { ?>
																	...
																	<div class="product-price">	
																		...
																		<span class="price-before-discount">
																			Rp. <?php echo htmlentities($row['productPriceBeforeDiscount']);?>
																		</span>
																	</div>
																</div>
																		...
																		<ul class="list-unstyled">
																			<li class="add-cart-button btn-group">
																				...
																				<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
																					<button class="btn btn-primary" type="button">Masukkan Keranjang</button></a>
																				</li>
													...
													<?php } } else {?>
														<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>Produk Tidak Ditemukan</h3>
														</div>
													<?php } ?>	
												</div>
											</div>
