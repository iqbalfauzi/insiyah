								...
								<div class="tab-pane active " id="grid-container">
									<div class="category-product  inner-top-vs">
										...
										while($d=mysqli_fetch_array($sql_edit)){
											?>
											<form id="form" class="form-horizontal" action="action_reseller_edit.php" method="post">
												<input type="hidden" id="id_data" name="id_data" value="<?php echo $d['id'] ?>">>
												<div class="form-body">
													<div class="form-group">
														<label class="control-label col-md-3">Nama</label>
														<div class="col-md-9">
															<input name="nama" id="nama" placeholder="Nama" class="form-control" type="text" value="<?php echo $d['nama'] ?>">
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-9">
															<input name="email" id="email" placeholder="Email" class="form-control" type="text" value="<?php echo $d['email'] ?>">
															<span class="help-block"></span>
														</div>
													</div>
												</div>
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-9">
															<input name="noHP" id="noHP" placeholder="Nomor HP" class="form-control" type="text" value="<?php echo $d['noHP'] ?>">
															<span class="help-block"></span>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-9">
														<select data-placeholder="Pilih Jenis Kelamin" name="jeniskelamin" id="jeniskelamin" class="form-control">
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-9">
															<input name="username" id="username" placeholder="Username" class="form-control" type="text" value="<?php echo $d['username'] ?>">
															<span class="help-block"></span>
														</div>
													</div>
												</div>
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-9">
															<input name="password" id="password" placeholder="Password" class="form-control" type="password" value="<?php echo $d['password'] ?>">
															<span class="help-block"></span>
														</div>
													</div>
												</div>
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-9">
															<textarea rows="5" cols="40" class="form-control" name="alamat"><?php echo $d['alamat'] ?></textarea>
														</div>
													</div>
												</div>
												<div class="col-md-12">
