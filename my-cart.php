		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-qty item">Jumlah Barang</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<!--<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Lanjut Belanja</a>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rp"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rp"." ".$row['shippingCharge']; ?>.00</span></td>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Alamat Penagihan</span>
				</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Checkout</button>
