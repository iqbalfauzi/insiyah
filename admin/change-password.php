							...
							<div class="module-body">
								...
								<form class="form-horizontal row-fluid" name="chngpwd" method="post" onSubmit="return valid();">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Kata Sandi Saat Ini</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Kata Sandi Baru</label>
										<div class="controls">
