...
<ul class="widget widget-menu unstyled">
			<li>
				<a class="collapsed" data-toggle="collapse" href="#togglePagesrating">
					<i class="menu-icon icon-cog"></i>
					<i class="icon-chevron-down pull-right"></i><i class="icon-chevron-up pull-right"></i>
					Pengaturan Rating 
				</a>
				<ul id="togglePagesrating" class="collapse unstyled">					
					<li><a href="rating.php"><i class="menu-icon icon-tasks"></i>Proses Rating barang</a></li> 
		</ul>
	</li>
</ul>
<ul class="widget widget-menu unstyled">
	<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>User Login Log </a></li>
	<li><a href="seller.php"><i class="menu-icon icon-tasks"></i>Daftar Seller</a></li>
