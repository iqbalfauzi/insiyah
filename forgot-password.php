...
<html lang="en">
	<head>
	    ...
	    <title>Happy Shopping di Toko Empat Saudara| Lupa Kata Sandi/title>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">No Telepon <span>*</span></label>
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Ubah</button>
	</form>					
</div>
<!-- Sign-in -->
