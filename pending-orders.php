...
<html lang="en">
	<head>
	    ...
	    <title>Riwayat Pesanan Tertunda</title>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Lanjutkan ke pembayaran</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Hasil Tidak Ditemukan</h4></td>
</tr>
<?php } ?>
